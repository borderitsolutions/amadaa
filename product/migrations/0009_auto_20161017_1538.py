# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-17 15:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0008_auto_20161016_2114'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='price',
            name='local_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='GHS', max_digits=10),
        ),
        migrations.AddField(
            model_name='price',
            name='local_price_currency',
